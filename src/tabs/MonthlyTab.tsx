  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <Section title="Помесячный расчёт — выручка, СС, маржа, результат" accent="monthly"
        description="Годовой надой = поголовье × средний надой на голову. Производство и реализация распределяются по месяцам по сезонному профилю; себестоимость реализации месяца = годовая СС 1 кг произведённого молока × реализация месяца.">
